  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-800">Arca Financeiro      <p className="text-gray-600 font-normal leading-7 text-lg">Gerencie suas receitas e despesas</p>
        </div>
